...
import com.huiyang.PBFTnet.bftsmart.consensus.roles.Proposer;
import com.huiyang.PBFTnet.bftsmart.reconfiguration.Reconfiguration;
import com.huiyang.PBFTnet.bftsmart.reconfiguration.ReconfigureReply;
import com.huiyang.PBFTnet.bftsmart.reconfiguration.ServerViewController;
import com.huiyang.PBFTnet.bftsmart.reconfiguration.VMMessage;
import com.huiyang.PBFTnet.bftsmart.tom.core.ReplyManager;
...
import com.huiyang.PBFTnet.bftsmart.tom.server.Executable;
import com.huiyang.PBFTnet.bftsmart.tom.server.FIFOExecutable;
import com.huiyang.PBFTnet.bftsmart.tom.server.Recoverable;
import com.huiyang.PBFTnet.bftsmart.tom.server.Replier;
import com.huiyang.PBFTnet.bftsmart.tom.server.SingleExecutable;

import com.huiyang.PBFTnet.bftsmart.tom.server.defaultservices.DefaultReplier;
import com.huiyang.PBFTnet.bftsmart.tom.util.ShutdownHookThread;
...
public class ServiceReplica {
	...
	public void receiveMessages(int consId[], int regency, TOMMessage[][] requests) {
		...
		for(TOMMessage[] requestsFromConsensus : requests) {
				...
				if (request.getViewID() == SVController.getCurrentViewId()) {	
					...
					if (request.getReqType() == TOMMessageType.ORDERED_REQUEST) {
						...
						if(executor instanceof BatchExecutable) {
							...
							com.huiyang.PBFTnet.bftsmart.tom.util.Logger.println("(ServiceReplica.receiveMessages) sending reply to " + request.getSender());
			...
			//DEBUG
					com.huiyang.PBFTnet.bftsmart.tom.util.Logger.println("BATCHEXECUTOR END");
		}
	}
